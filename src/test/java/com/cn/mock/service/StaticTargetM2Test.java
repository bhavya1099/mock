...
public class StaticTargetM2Test {
	...
	public void testPrintedConsoleMessageFromM2() {
		try {
			...
			// Exception expectations handled in testM2ThrowsRuntimeException
			// We are only concerned about the print message in this test.
		}
		assertEquals("StaticTarget m2", outContent.toString().trim());
	}
