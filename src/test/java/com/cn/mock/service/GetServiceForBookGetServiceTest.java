...
public class GetServiceForBookGetServiceTest {
	...
	@Test
	public void testGetServiceForNovel() {
	...
	@Test
	public void testGetServiceForNonNovel() {
		GetServiceForBook getServiceForBook = new GetServiceForBook();
	...
	@Test
	public void testGetServiceForNull() {
		GetServiceForBook getServiceForBook = new GetServiceForBook();
	...
	@Test
	public void testGetServiceForEmptyString() {
		GetServiceForBook getServiceForBook = new GetServiceForBook();
		int result = getServiceForBook.getService("");
		assertEquals(2, result);
	}
