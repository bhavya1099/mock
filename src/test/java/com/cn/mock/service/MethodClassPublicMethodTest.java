...
import com.cn.mock.MethodClassPublic;
import org.junit.experimental.categories.Category;

@Category({ Categories.publicMethod.class, Categories.roostTest1.class, Categories.roostTest2.class })
// Importing the actual class MethodClassPublicMethodTest resolve the not found error.
class MethodClassPublicMethodTest {

	private MethodClassPublic methodClassUnderTest = new MethodClassPublic();

	@Test
	public void testSuccessfulExecutionOfPublicMethod() {
		// Act
		String result = methodClassUnderTest.publicMethod();
		// Assert
